...
class MyPlanner:
  ...
  def collision_checking(self,startPoint, endPoint, box):
      ...
      if endPoint[0]>box[0][0] and endPoint[0]<box[1][0] and endPoint[1]>box[0][1] and endPoint[1]<box[1][1]:
          return 1
  ...
  def verify_node(self,node1, node2):
      ...
      for k in range(self.blocks.shape[0]):
        box=np.array([[self.blocks[k][0],self.blocks[k][1],self.blocks[k][2]],[self.blocks[k][3],self.blocks[k][4],self.blocks[k][5]]])
