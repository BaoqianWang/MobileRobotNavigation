...
void loop() {
  ...
  shaftFrequencies motors34 = getShaftFrequencies(SLAVE_ADDRESS_2);
  ...
  Serial.write(loadFloat(motors12.shaft1Freq).c); //4 bytes
  Serial.write(loadFloat(motors12.shaft2Freq).c); //4 bytes
  Serial.write(loadFloat(motors34.shaft1Freq).c); //4 bytes
  Serial.write(loadFloat(motors34.shaft2Freq).c); //4 bytes
  
  Serial.write(loadFloat(a.acceleration.x).c); // 1 byte
  Serial.write(loadFloat(a.acceleration.y).c); // 1 byte
  Serial.write(loadFloat(a.acceleration.z).c); // 1 byte
  
  Serial.write(loadFloat(m.magnetic.x).c); // 1 
  Serial.write(loadFloat(m.magnetic.y).c); // 1
  Serial.write(loadFloat(m.magnetic.z).c); // 1
  
  Serial.write(loadFloat(g.gyro.x).c); // 1
  Serial.write(loadFloat(g.gyro.y).c); // 1
  Serial.write(loadFloat(g.gyro.z).c); // 1
